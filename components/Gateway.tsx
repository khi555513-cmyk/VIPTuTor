...
import { ShieldCheck, Sparkles, Zap, GraduationCap, Lock, Key } from 'lucide-react';
      ...
      <div className="w-full max-w-md relative z-10 text-center space-y-8 animate-fade-in">
        ...
        <div className="grid grid-cols-2 gap-3 text-left">
           ...
           <div className="bg-white/5 border border-white/10 p-4 rounded-xl backdrop-blur-sm">
              ...
              <p className="text-slate-500 text-[10px] leading-relaxed">Xác thực chính chủ qua AI Studio.</p>
           </div>
        </div>
